...
# kubectl config use-context arn:aws:eks:$AWS_REGION:727646471862:cluster/$CLUSTER_NAME
...
# kubectl rollout status deployment/$APP_NAME --context=arn:aws:eks:$AWS_REGION:727646471862:cluster/$CLUSTER_NAME
...
# kubectl config use-context arn:aws:eks:$SECONDARY_AWS_REGION:727646471862:cluster/$SECONDARY_CLUSTER_NAME
...
# kubectl rollout status deployment/$APP_NAME -n dr --context=arn:aws:eks:$SECONDARY_AWS_REGION:727646471862:cluster/$SECONDARY_CLUSTER_NAME

# log "Deployment completed successfully in both regions!"

# # Get service URLs
# log "Service URL in primary cluster:"
# kubectl get svc react-app-service -o jsonpath='{.status.loadBalancer.ingress[0].hostname}' --context=arn:aws:eks:$AWS_REGION:727646471862:cluster/$CLUSTER_NAME

# log "Service URL in secondary cluster:"
# kubectl get svc react-app-service -n dr -o jsonpath='{.status.loadBalancer.ingress[0].hostname}' --context=arn:aws:eks:$SECONDARY_AWS_REGION:727646471862:cluster/$SECONDARY_CLUSTER_NAME
