...
export CART_ECR_REPO="392294087512.dkr.ecr.us-west-2.amazonaws.com/dev-cart_service_secondary"
export FRONTEND_ECR_REPO="392294087512.dkr.ecr.us-west-2.amazonaws.com/react-app-repo-secondary"
